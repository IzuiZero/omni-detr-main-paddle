...
def main():
    ...
    output_file_label = (root_dir +
        'instances_valminusminival2014_w_indicator.json')
    ...
    data['licenses'] = coco_api.dataset['licenses']
    output_file_label = (root_dir +
        'instances_train2014_w_indicator_pointsK.json')
    with open(output_file_label, 'w') as f:
        print('writing to json output:', output_file_label)
        json.dump(data, f, sort_keys=True)
