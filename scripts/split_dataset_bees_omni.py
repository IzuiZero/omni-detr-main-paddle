...
def main():
    ...
    output_file_label = (
        '{}{}_bees_omni_label_seed{}_{}fully{}Unsup{}tagsU{}tagsK{}pointsU{}pointsK{}boxesEC{}boxesU.json'
    ...
    output_file_unlabel = (
        '{}{}_bees_omni_unlabel_seed{}_{}fully{}Unsup{}tagsU{}tagsK{}pointsU{}pointsK{}boxesEC{}boxesU.json'
        .format(root_dir, data_set, random_seed, round(100 * fully_labeled),
        round(100 * Unsup), round(100 * tagsU), round(100 * tagsK), round(
        100 * pointsU), round(100 * pointsK), round(100 * boxesEC), round(
        100 * boxesU)))
