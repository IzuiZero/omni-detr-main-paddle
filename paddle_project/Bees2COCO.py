...
def get_categories(xml_files):
    ...
    paddle.sort(x=classes_names), paddle.argsort(x=classes_names)
...
def convert(xml_files, json_file):
    ...
    for xml_file in xml_files:
        ...
        if width > 600 or height > 600:
            if (width <= height and width == 600 or height <= width and 
                height == 600):
                oh = height
                ow = width
            if width < height:
            ...
            image = {'file_name': filename_original, 'height': oh, 'width':
                ow, 'id': image_id}
            ...
            image = {'file_name': filename_original, 'height': height,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--xml_dir', default='../bees/ML-Data/', help=
        'Directory path to xml files.', type=str)
    parser.add_argument('--json_file', default=
        '../bees/instances_bees.json', help='Output COCO format json file.',
        type=str)
